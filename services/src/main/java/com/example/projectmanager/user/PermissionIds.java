...
public final class PermissionIds {
    ...
    public static final String REQUIREMENT_VIEW = "09C7BFF15364437F9AAF770811D2DA5C";
    public static final String REQUIREMENT_MANAGE = "2549192438C64A56A4B14CFEF84BA20A";
    public static final String BUG_VIEW = "80C74D26970740AAA13AD5DA692D8001";
    ...
    public static Set<String> all() {
        return Set.of(
                ...
                TASK_VIEW, TASK_MANAGE, REQUIREMENT_VIEW, REQUIREMENT_MANAGE, BUG_MANAGE,
                BUG_VIEW, CHANGE_MANAGE, RELEASE_MANAGE, REPORT_VIEW
        );
    }
    ...
    public static Map<String, String> names() {
        return Map.ofEntries(
                ...
                Map.entry(REQUIREMENT_VIEW, "查看需求"),
                Map.entry(REQUIREMENT_MANAGE, "管理需求"),
                Map.entry(BUG_VIEW, "查看 Bug"),
