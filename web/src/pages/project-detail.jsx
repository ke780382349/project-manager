...
function ProjectDetail({ projectId, currentUser, onBack }) {
  ...
  if (loading) {
    return <section className="content-card project-list-card"><div className="table-empty">正在加载项目…</div></section>;
  }
    ...
    return (
      <>
        <div className="page-heading">
          <div><p className="eyebrow">PROJECT DETAIL</p><h1>项目详情</h1><p className="muted">无法加载该项目。</p></div>
        </div>
